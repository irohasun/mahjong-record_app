...
try:
    font_large = ImageFont.truetype(font_path, 180) if font_path else ImageFont.load_default()
    font_medium = ImageFont.truetype(font_path, 150) if font_path else ImageFont.load_default()
...
text_configs = {
    'add-game.png': [
        {"text": "サクサク簡単", "color": (255, 255, 255, 255), "font": font_large, "y": 200},
        {"text": "毎日の対局を", "color": (255, 255, 255, 255), "font": font_large, "y": 420},
        {"text": "記録", "color": frame_color, "font": font_large, "y": 420, "inline": True}
    ],
    'group-details.png': [
        {"text": "友達やグループで", "color": (255, 255, 255, 255), "font": font_large, "y": 200},
        {"text": "成績を", "color": (255, 255, 255, 255), "font": font_large, "y": 420},
        {"text": "共有", "color": frame_color, "font": font_large, "y": 420, "inline": True}
    ],
    'home.png': [
        {"text": "過去の対局も", "color": (255, 255, 255, 255), "font": font_large, "y": 200},
        {"text": "ひと目で", "color": (255, 255, 255, 255), "font": font_large, "y": 420},
        {"text": "振り返る", "color": frame_color, "font": font_large, "y": 420, "inline": True}
    ],
    'statistics.png': [
        {"text": "統計画面で", "color": (255, 255, 255, 255), "font": font_large, "y": 200},
        {"text": "雀力を", "color": (255, 255, 255, 255), "font": font_large, "y": 420},
        {"text": "見える化", "color": frame_color, "font": font_large, "y": 420, "inline": True}
    ],
    'account.png': [
        {"text": "シンプルで", "color": (255, 255, 255, 255), "font": font_large, "y": 200},
        {"text": "洗練された", "color": (255, 255, 255, 255), "font": font_large, "y": 420},
        {"text": "デザイン", "color": frame_color, "font": font_large, "y": 420, "inline": True}
    ]
}
...
os.makedirs('screenshots/composited_ipad', exist_ok=True)

for filename, text_config in text_configs.items():
    raw_path = os.path.join('screenshots/raw_ipad', filename)
    ...
    out_path = os.path.join('screenshots/composited_ipad', filename)
    bg.save(out_path)
